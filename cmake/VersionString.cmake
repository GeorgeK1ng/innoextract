...
# The version file is regenerated whenever VERSION_FILE or the current git version changes.
function(version_file SRC DST VERSION_SOURCES GIT_DIR)
	...
	if(EXISTS "${abs_git_dir}")
		...
		if(EXISTS "${abs_git_dir}/refs/tags")
			file(GLOB_RECURSE git_tag_refs "${abs_git_dir}/refs/tags/*")
			list(APPEND dependencies ${git_tag_refs})
		endif()
...
function(parse_version_file names file)
	...
	if(DEFINED ${var}_0_OVERRIDE)
		string(REGEX REPLACE "^[^\n]+\n?" "" contents_tail "${contents}")
		if(contents_tail STREQUAL "")
			set(contents "${${var}_0_OVERRIDE}")
		else()
			set(contents "${${var}_0_OVERRIDE}\n${contents_tail}")
		endif()
	endif()
